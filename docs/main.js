...
module.exports = "<div class=\"home-container\">\n  <div class=\"home-header\">\n    <img class=\"logo\" src=\"../../../assets/logo.png\">\n    <h1 class=\"subTitle\">{{event.subTitle}}</h1>\n    <h1 class=\"title\">{{event.title}}</h1>\n    <br>\n    <h1 class=\"info\">{{event.date}}</h1>\n    <h1 class=\"info\">{{event.time}}</h1>\n    <h1 class=\"info\">{{event.venue}}</h1>\n  </div>\n  <div class=\"links-container\">\n    <div class=\"card\" *ngFor=\"let link of links\">\n      <div class=\"card-body\">\n        <h4 class=\"card-title\">{{link.title}}</h4>\n        <a class=\"card-subtitle\" [href]=\"link.url\" target=\"_blank\">{{link.url}}</a>\n      </div>\n      <div class=\"card-body qr-code-wrapper\">\n        <img class=\"card-img-top qr-code\" [src]=\"link.qrUrl\">\n      </div>\n    </div>\n  </div>\n  <div class=\"footer\">\n    Made with <i class=\"fa fa-heart\" style=\"color: red\"></i> by <a href=\"https://www.ntuoss.com/\" target=\"_blank\">NTUOSS</a>\n  </div>\n</div>"
...
module.exports = ".home-container {\n  max-width: 80%;\n  margin: 0 auto;\n  height: 100%;\n  display: flex;\n  flex-direction: column;\n  padding-top: 6vmin; }\n\n.title,\n.subTitle {\n  font-size: 2rem; }\n\n.info {\n  font-size: 1.5rem;\n  color: #1b1b1b;\n  font-weight: 300; }\n\n.footer {\n  padding-top: 12vmin;\n  width: 100%;\n  text-align: center;\n  padding: 6vmin; }\n\n.home-header {\n  flex: 1; }\n\n.home-header img.logo {\n    width: 300px;\n    margin-bottom: 2vmin; }\n\n.home-description {\n  flex: 1;\n  font-size: 1rem; }\n\n.links-container {\n  display: flex; }\n\n.links-container .card {\n    flex: 1;\n    margin: 12px;\n    background: rgba(255, 255, 255, 0.6);\n    text-align: center; }\n\n.links-container .card .qr-code-wrapper {\n      text-align: center;\n      padding: 4vmin;\n      padding-top: 2vmin; }\n\n.links-container .card .qr-code-wrapper .qr-code {\n        -webkit-transform: translateX(calc(30vmin*10/740/2));\n                transform: translateX(calc(30vmin*10/740/2));\n        height: 30vmin;\n        width: 30vmin;\n        margin-right: -6vmin;\n        margin-bottom: -6vmin; }\n\n@media screen and (max-width: 760px) {\n  .title,\n  .subTitle,\n  .info {\n    font-size: 1.2rem; }\n  .home-header {\n    text-align: center; }\n  .links-container {\n    flex-flow: column; } }\n"
...
module.exports = __webpack_require__(/*! /Users/clarencecastillo/Workspaces/ntuoss/tgifhacks/src/main.ts */"./src/main.ts");
